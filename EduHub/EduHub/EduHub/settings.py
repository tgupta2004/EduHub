...
SECRET_KEY = 'django-insecure-*9ezc2iz-@ik%6rm_tt@j6!sa&q4bas8x#w^5wb9+9ykgg(kks'
...
MIDDLEWARE = [
    ...
    # Other middlewares
    'EduHub.middlewares.DDoSProtectionMiddleware',  # Replace with the actual path

    'django.middleware.locale.LocaleMiddleware',  # ✅ Correct middleware for locale
]
